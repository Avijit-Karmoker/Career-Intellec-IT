...
<head>
	...
	<link href="{{ asset('backend-asset') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('backend-asset') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('backend-asset') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('backend-asset') }}/images/logo-text.png" alt="">
            </a>
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card" style="background-color: rgb(184, 184, 184)">
                            <div class="card-header">
